...
var TableRow = {
  ...
  props: (0, _propsUtil.initDefaultProps)({
    ...
    hovered: _vueTypes.default.looseBool.isRequired,
    visible: _vueTypes.default.looseBool.isRequired,
  ...
  methods: {
    ...
    setRowHeight: function setRowHeight() {
      ...
      var height = this.rowRef.getBoundingClientRect().height;
      store.setState({
        fixedColumnsBodyRowsHeight: _extends(_extends({}, fixedColumnsBodyRowsHeight), _defineProperty({}, rowKey, height))
      });
    },
