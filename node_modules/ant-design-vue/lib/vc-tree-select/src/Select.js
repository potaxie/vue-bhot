...
var Select = (0, _vue.defineComponent)({
  ...
  methods: {
    ...
    delayForcePopupAlign: function delayForcePopupAlign() {
      ...
      (0, _raf.default)(function () {
        (0, _raf.default)(_this5.forcePopupAlign);
      });
    },
  ...
  render: function render() {
    ...
    var $popup = (0, _vue.createVNode)(_MultiplePopup.default, _objectSpread(_objectSpread({}, popupProps), {}, {
      "__propsSymbol__": []
    }), null);
    var Selector = isMultiple ? _MultipleSelector.default : _SingleSelector.default;
    var $selector = (0, _vue.createVNode)(Selector, _objectSpread(_objectSpread({}, passProps), {}, {
      "isMultiple": isMultiple,
