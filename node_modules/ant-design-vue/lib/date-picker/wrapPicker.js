  ...
  return (0, _vue.defineComponent)({
    ...
    methods: {
      ...
      getDefaultLocale: function getDefaultLocale() {
        var result = _extends(_extends({}, _en_US.default), this.locale);
      ...
      renderPicker: function renderPicker(locale, localeCode) {
        ...
        var vcTimePickerProps = _extends(_extends({}, (0, _timePicker.generateShowHourMinuteSecond)(timeFormat)), {
          format: timeFormat,
        ...
        return (0, _vue.createVNode)(Picker, pickerProps, _objectSpread({}, this.$slots));
      }
    },
