...
var _default = (0, _vue.defineComponent)({
  ...
  render: function render() {
    ...
    if (this.simple) {
      ...
      return (0, _vue.createVNode)("ul", _objectSpread({
    ...
    if (allPages <= 5 + pageBufferSize * 2) {
      ...
      if (!allPages) {
        pagerList.push((0, _vue.createVNode)(_Pager.default, _objectSpread(_objectSpread({}, pagerProps), {}, {
          "key": "noPager",
          "page": allPages,
    ...
    return (0, _vue.createVNode)("ul", _objectSpread(_objectSpread({
      "unselectable": "unselectable",
      "ref": "paginationNode"
    }, restAttrs), {}, {
      "class": (0, _classNames2.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls), true), _defineProperty(_classNames, "".concat(prefixCls, "-disabled"), disabled), _classNames), className)
    }), [totalText, (0, _vue.createVNode)("li", {
      "title": this.showTitle ? locale.prev_page : null,
      "onClick": this.prev,
