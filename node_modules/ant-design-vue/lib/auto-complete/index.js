...
var AutoComplete = (0, _vue.defineComponent)({
  ...
  props: _extends(_extends({}, AutoCompleteProps), {
    ...
    showSearch: _vueTypes.default.looseBool.def(false),
  ...
  setup: function setup(props, _ref) {
    ...
    (0, _warning.default)(!('dataSource' in props || 'dataSource' in slots), 'AutoComplete', '`dataSource` is deprecated, please use `options` instead.');
    return {
