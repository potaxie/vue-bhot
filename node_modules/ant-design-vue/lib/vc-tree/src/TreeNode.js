...
var TreeNode = (0, _vue.defineComponent)({
  ...
  methods: {
    ...
    renderSelector: function renderSelector() {
      ...
      }, [typeof currentTitle === 'function' ? currentTitle(_extends(_extends({}, this.$props), this.$props.dataRef)) : currentTitle]) : (0, _vue.createVNode)("span", {
        "class": "".concat(prefixCls, "-title")
      }, [defaultTitle]);
      return (0, _vue.createVNode)("span", {
        "key": "selector",
