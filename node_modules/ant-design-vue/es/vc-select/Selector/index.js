...
var Selector = defineComponent({
  ...
  render: function render() {
    ...
    var selectNode = multiple ? createVNode(MultipleSelector, _objectSpread(_objectSpread({}, this.$props), sharedProps), null) : createVNode(SingleSelector, _objectSpread(_objectSpread({}, this.$props), sharedProps), null);
