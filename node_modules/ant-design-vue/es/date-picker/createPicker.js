import { defineComponent, inject, nextTick, createVNode, resolveDirective } from "vue";
...
export default function createPicker(TheCalendar, props, name) {
  return defineComponent({
    ...
    render: function render() {
      ...
      var calendar = createVNode(TheCalendar, theCalendarProps, _objectSpread({}, $slots));
      ...
      return createVNode("span", _objectSpread(_objectSpread({
        "id": props.id,
      ...
      }), [createVNode(VcDatePicker, vcDatePickerProps, _objectSpread({}, _extends({
        default: input
      }, $slots)))]);
    }
  });
