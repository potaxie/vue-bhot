    ...
    renderSelection: function renderSelection() {
      ...
      var selectedValueNodes = myValueList.map(function (_ref) {
        var label = _ref.label,
            value = _ref.value;
        return createVNode(Selection, _objectSpread(_objectSpread({}, _extends(_extends({}, _this.$props), {
          label: label,
          value: value,
      ...
      if (maxTagCount >= 0 && maxTagCount < selectorValueList.length) {
        ...
        var restNodeSelect = createVNode(Selection, _objectSpread(_objectSpread({}, _extends(_extends({}, this.$props), {
          label: content,
          value: null
        })), {}, {
      ...
      selectedValueNodes.push(createVNode(SearchInput, _objectSpread(_objectSpread(_objectSpread({
        "key": "SearchInput"
