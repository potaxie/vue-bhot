...
var Select = defineComponent({
  ...
  render: function render() {
    ...
    var $popup = createVNode(BasePopup, _objectSpread(_objectSpread({}, popupProps), {}, {
      "__propsSymbol__": []
    }), null);
    var Selector = isMultiple ? MultipleSelector : SingleSelector;
    var $selector = createVNode(Selector, _objectSpread(_objectSpread({}, passProps), {}, {
      "isMultiple": isMultiple,
    ...
    return createVNode(SelectTrigger, selectTriggerProps, {
