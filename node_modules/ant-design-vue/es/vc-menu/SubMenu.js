...
import { computed, defineComponent, getCurrentInstance, inject, onBeforeUnmount, onMounted, provide, reactive, createVNode, vShow, resolveDirective, withDirectives } from "vue";
  ...
  renderChildren: function renderChildren() {
    ...
    return createVNode(Transition, transitionProps, {
      default: function _default() {
        return [withDirectives(createVNode(SubPopupMenu, subPopupMenuProps, _objectSpread({}, _this5.$slots)), [[vShow, _this5.isOpen]])];
      }
    });
  }
