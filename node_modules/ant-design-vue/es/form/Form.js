import { defineComponent, inject, provide, computed, createVNode } from "vue";
...
var Form = defineComponent({
  ...
  render: function render() {
    ...
    var _a = this.$attrs,
        className = _a.class,
        originSubmit = _a.onSubmit,
        restProps = __rest(_a, ["class", "onSubmit"]);
    ...
    return createVNode("form", _objectSpread({
