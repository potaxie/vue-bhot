import { defineComponent, provide, createVNode, vShow, withDirectives } from "vue";
...
export default defineComponent({
  ...
  methods: {
    ...
    getDialogElement: function getDialogElement() {
      ...
      var dialogElement = withDirectives(createVNode(LazyRenderBox, {
        ...
        default: function _default() {
          ...
          }, [closer, header, createVNode("div", _objectSpread({
            "key": "body",
    ...
    getMaskElement: function getMaskElement() {
      ...
      if (props.mask) {
        ...
        var tempMaskElement = withDirectives(createVNode(LazyRenderBox, _objectSpread({
        ...
        if (maskTransition) {
          ...
          maskElement = createVNode(Transition, _objectSpread({
            "key": "mask"
          }, maskTransitionProps), {
            default: function _default() {
  ...
  render: function render() {
    ...
    }, [this.getMaskElement(), createVNode("div", _objectSpread({
      "tabindex": -1,
