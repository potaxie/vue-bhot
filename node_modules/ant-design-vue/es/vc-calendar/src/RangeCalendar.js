...
var RangeCalendar = defineComponent({
  ...
  render: function render() {
    ...
    if (showToday) {
      ...
      TodayButtonNode = createVNode(TodayButton, _objectSpread({
        "key": "todayButton"
    ...
    if (props.timePicker) {
      ...
      TimePickerButtonNode = createVNode(TimePickerButton, _objectSpread({
    ...
    if (showOkButton) {
      ...
      OkButtonNode = createVNode(OkButton, _objectSpread({
        "key": "okButtonNode"
      }, okButtonProps), null);
    }
